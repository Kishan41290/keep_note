			...
			<div class="col-md-10">
				...
				<div class="box box-primary">
					...
					<form class="form-horizontal" id="product_form" enctype="multipart/form-data" action="<?php echo $action; ?>" method="post">
						...
						<!-- /.box-body -->
						<input type="hidden" name="csrf_name" id="csrf_name1" value="<?php echo htmlspecialchars($unique_form_name);?>"/>
						<input type="hidden" name="csrf_token" id="csrf_token1" value="<?php echo htmlspecialchars($token);?>"/>
