							...
							<div class="form-group">
								...
								<div class="col-md-5 col-sm-10">
									...
									<?php if($method=="Edit"){ ?>
										...
										<img src="<?php echo $img!='' ? site_url('uploads/admin/thumb/'.set_value('image',$img)) : site_url('uploads/default/default.png'); ?>" alt="display_image" class="imgdp" height="34px" width="35px">
									<?php } ?>
